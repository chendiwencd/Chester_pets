...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::get_auto_sync,
            commands::get_text_upload_batch_size,
            ...
            commands::save_file_data_url_to_material_silent,
            commands::save_file_to_material,
            commands::save_file_to_material_silent,
            commands::set_autostart,
            commands::set_close_on_blur,
            commands::set_auto_sync,
            commands::set_text_upload_batch_size,
            ...
            commands::update_history_upload_state,
